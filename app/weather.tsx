        ...
        <div className="flex flex-col  w-3/4 h-3/4 bg-blue-500 bg-opacity-15">
            <div className="flex flex-row flex-wrap justify-between">
                ...
                <div className="flex justify-center md:justify-normal md:flex-col  ">
                    <div className="hidden md:flex justify-end">
                        <img alt="weather icon" className=" " src={`https://openweathermap.org/img/wn/${props.weather[0]['icon']}@2x.png`} />
                    </div>
            ...
            <div className="wheather my-5 flex justify-center items-center">
                <div className="flex flex-col ">
                    ...
                    <div className=""><img alt="weather icon" className=" mx-auto size-40 " src={`https://openweathermap.org/img/wn/${props.weather[0]['icon']}@2x.png`} /></div>
